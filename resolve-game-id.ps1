...
elseif ($SelfTest) {
  $cases = @(
    ...
    # --- 改善⑤: 登録not-foundを直接減らす安全な表記ゆれ・略称alias 30件(各aliasは単一ゲームにのみ収束) ---
    @{ n = "77. 和名表記alias ポケモンレジェンズZ-A"; input = "ポケモンレジェンズZ-A";       expectType = "alias-exact";      expectId = "Pokémon LEGENDS Z-A" },
    @{ n = "77a. 空白入りでも同じゲームへ";   input = "ポケモン レジェンズ Z-A";       expectType = "canonical-alias";  expectId = "Pokémon LEGENDS Z-A" },
    @{ n = "77b. 全角英字・全角ハイフン";     input = "ポケモンレジェンズＺ－Ａ";        expectType = "canonical-alias";  expectId = "Pokémon LEGENDS Z-A" },
    @{ n = "77c. ハイフン入り略称alias";      input = "ポケモンZ-A";                   expectType = "alias-exact";      expectId = "Pokémon LEGENDS Z-A" },
    @{ n = "77d. 既存alias ポケモンZA は従来どおり"; input = "ポケモンZA";              expectType = "alias-exact";      expectId = "Pokémon LEGENDS Z-A" },
    @{ n = "77e. 部分語では解決しない";       input = "ポケモンレジェンズ";             expectType = "not-found";        expectId = $null },
    @{ n = "77f. 別作品アルセウスへ寄らない"; input = "ポケモンレジェンズアルセウス";   expectType = "not-found";        expectId = $null },
    @{ n = "78. 略称alias マリカワールド";    input = "マリカワールド";                 expectType = "alias-exact";      expectId = "マリオカートワールド" },
    @{ n = "78a. ひらがな表記";               input = "まりかわーるど";                 expectType = "canonical-alias";  expectId = "マリオカートワールド" },
    @{ n = "78b. 数字が続く場合は解決しない"; input = "マリカワールド2";                expectType = "not-found";        expectId = $null },
    @{ n = "78c. マリカ単独は解決しない(REJECT維持)"; input = "マリカ";                 expectType = "not-found";        expectId = $null },
    @{ n = "78d. 別作品マリオカート8DXは従来どおり"; input = "マリオカート8DX";         expectType = "alias-exact";      expectId = "マリオカート8 デラックス" },
    @{ n = "79. 略称alias デレステ";          input = "デレステ";                       expectType = "alias-exact";      expectId = "アイドルマスター シンデレラガールズ スターライトステージ" },
    @{ n = "79a. 半角カナ表記";               input = "ﾃﾞﾚｽﾃ";                        expectType = "canonical-alias";  expectId = "アイドルマスター シンデレラガールズ スターライトステージ" },
    @{ n = "79b. 部分語では解決しない";       input = "デレ";                           expectType = "not-found";        expectId = $null },
    @{ n = "79c. 別作品シャイニーカラーズは従来どおり"; input = "アイドルマスター シャイニーカラーズ"; expectType = "exact"; expectId = "アイドルマスター シャイニーカラーズ" },
    @{ n = "80. 略称alias デュエプレ";        input = "デュエプレ";                     expectType = "alias-exact";      expectId = "デュエル・マスターズ プレイス" },
    @{ n = "80a. 別作品マスターデュエルは従来どおり"; input = "遊戯王マスターデュエル";   expectType = "exact";            expectId = "遊戯王マスターデュエル" },
    @{ n = "81. 和名表記alias ポケモンチャンピオンズ"; input = "ポケモンチャンピオンズ";   expectType = "alias-exact";      expectId = "Pokémon Champions" },
    @{ n = "81a. 部分語では解決しない";       input = "ポケモンチャンピオン";           expectType = "not-found";        expectId = $null },
    @{ n = "81b. 別作品キャプテン翼は従来どおり"; input = "キャプテン翼 -RISE OF NEW CHAMPIONS-"; expectType = "exact";    expectId = "キャプテン翼 -RISE OF NEW CHAMPIONS-" },
    @{ n = "82. 略称alias ブルアカ";          input = "ブルアカ";                       expectType = "alias-exact";      expectId = "ブルーアーカイブ" },
    @{ n = "82a. ひらがな表記";               input = "ぶるあか";                       expectType = "canonical-alias";  expectId = "ブルーアーカイブ" },
    @{ n = "82b. 別作品グラブルは従来どおり"; input = "グラブル";                       expectType = "alias-exact";      expectId = "グランブルーファンタジー" },
    @{ n = "83. 略称alias ピカブイ";          input = "ピカブイ";                       expectType = "alias-exact";      expectId = "Pokémon Let's Go! ピカチュウ・イーブイ" },
    @{ n = "83a. ピカチュウ単独は解決しない"; input = "ピカチュウ";                     expectType = "not-found";        expectId = $null },
    @{ n = "84. 中国語題alias 第五人格";      input = "第五人格";                       expectType = "alias-exact";      expectId = "Identity V" },
    @{ n = "84a. 部分語では解決しない";       input = "第五";                           expectType = "not-found";        expectId = $null },
    @{ n = "85. ナンバリング表記alias バイオハザード8"; input = "バイオハザード8";      expectType = "alias-exact";      expectId = "バイオハザード ヴィレッジ" },
    @{ n = "85a. 全角数字";                   input = "バイオハザード８";               expectType = "canonical-alias";  expectId = "バイオハザード ヴィレッジ" },
    @{ n = "85b. 数字が続く場合は解決しない"; input = "バイオハザード80";               expectType = "not-found";        expectId = $null },
    @{ n = "85c. シリーズ名だけでは解決しない"; input = "バイオハザード";               expectType = "not-found";        expectId = $null },
    @{ n = "85d. 別作品7は従来どおり";        input = "バイオハザード7 レジデント イービル"; expectType = "exact";       expectId = "バイオハザード7 レジデント イービル" },
    @{ n = "86. カタカナ表記alias パルワールド"; input = "パルワールド";                expectType = "alias-exact";      expectId = "Palworld" },
    @{ n = "87. カタカナ表記alias ブラッドボーン"; input = "ブラッドボーン";            expectType = "alias-exact";      expectId = "Bloodborne" },
    @{ n = "87a. 部分語では解決しない";       input = "ブラッド";                       expectType = "not-found";        expectId = $null },
    @{ n = "88. カタカナ表記alias FF8";       input = "ファイナルファンタジー8";        expectType = "alias-exact";      expectId = "FINAL FANTASY VIII" },
    @{ n = "88a. 全角数字";                   input = "ファイナルファンタジー８";       expectType = "canonical-alias";  expectId = "FINAL FANTASY VIII" },
    @{ n = "88b. シリーズ名だけでは解決しない"; input = "ファイナルファンタジー";       expectType = "not-found";        expectId = $null },
    @{ n = "88c. 別作品VIIは従来どおり";      input = "FINAL FANTASY VII";              expectType = "exact";            expectId = "FINAL FANTASY VII" },
    @{ n = "89. 和題alias 濡鴉ノ巫女";        input = "濡鴉ノ巫女";                     expectType = "alias-exact";      expectId = "Fatal Frame: Maiden of Black Water" },
    @{ n = "89a. ノ/の表記ゆれ";              input = "濡鴉の巫女";                     expectType = "canonical-alias";  expectId = "Fatal Frame: Maiden of Black Water" },
    @{ n = "89b. 別作品 零~眞紅の蝶~ は従来どおり"; input = "零~眞紅の蝶~";           expectType = "exact";            expectId = "零~眞紅の蝶~" },
    @{ n = "90. 略称alias ポケユナ";          input = "ポケユナ";                       expectType = "alias-exact";      expectId = "ポケモンユナイト" },
    @{ n = "91. カタカナ表記alias エースコンバット7"; input = "エースコンバット7";      expectType = "alias-exact";      expectId = "ACE COMBAT 7: SKIES UNKNOWN" },
    @{ n = "91a. 全角数字";                   input = "エースコンバット７";             expectType = "canonical-alias";  expectId = "ACE COMBAT 7: SKIES UNKNOWN" },
    @{ n = "91b. 別作品5は従来どおり";        input = "エースコンバット5";              expectType = "exact";            expectId = "エースコンバット5" },
    @{ n = "91c. シリーズ名だけでは解決しない"; input = "エースコンバット";             expectType = "not-found";        expectId = $null },
    @{ n = "92. 算用数字表記alias ドラゴンクエスト5"; input = "ドラゴンクエスト5";      expectType = "alias-exact";      expectId = "ドラゴンクエストV 天空の花嫁" },
    @{ n = "92a. 全角数字";                   input = "ドラゴンクエスト５";             expectType = "canonical-alias";  expectId = "ドラゴンクエストV 天空の花嫁" },
    @{ n = "92b. 基本作は従来どおり";         input = "ドラゴンクエスト";               expectType = "exact";            expectId = "ドラゴンクエスト" },
    @{ n = "92c. 別ナンバー6へは波及しない";  input = "ドラゴンクエスト6";              expectType = "not-found";        expectId = $null },
    @{ n = "93. 英語表記alias YAKUZA 5";      input = "YAKUZA 5";                       expectType = "alias-exact";      expectId = "龍が如く5 夢、叶えし者" },
    @{ n = "93a. 空白なし・大小文字";         input = "Yakuza5";                        expectType = "canonical-alias";  expectId = "龍が如く5 夢、叶えし者" },
    @{ n = "93b. シリーズ名だけでは解決しない"; input = "YAKUZA";                       expectType = "not-found";        expectId = $null },
    @{ n = "94. 前方表記alias ダンガンロンパ2"; input = "ダンガンロンパ2";              expectType = "alias-exact";      expectId = "スーパーダンガンロンパ2 さよなら絶望学園" },
    @{ n = "94a. 全角数字";                   input = "ダンガンロンパ２";               expectType = "canonical-alias";  expectId = "スーパーダンガンロンパ2 さよなら絶望学園" },
    @{ n = "94b. 基本作は従来どおり";         input = "ダンガンロンパ";                 expectType = "exact";            expectId = "ダンガンロンパ" },
    @{ n = "94c. 別作品V3は従来どおり";       input = "ニューダンガンロンパV3";         expectType = "exact";            expectId = "ニューダンガンロンパV3" },
    @{ n = "95. 前方表記alias 龍が如く4";     input = "龍が如く4";                      expectType = "alias-exact";      expectId = "龍が如く4 伝説を継ぐもの" },
    @{ n = "95a. 前方表記alias 龍が如く5";    input = "龍が如く5";                      expectType = "alias-exact";      expectId = "龍が如く5 夢、叶えし者" },
    @{ n = "95b. 前方表記alias 龍が如く6";    input = "龍が如く6";                      expectType = "alias-exact";      expectId = "龍が如く6 命の詩。" },
    @{ n = "95c. 全角数字";                   input = "龍が如く６";                     expectType = "canonical-alias";  expectId = "龍が如く6 命の詩。" },
    @{ n = "95d. 基本作は従来どおり";         input = "龍が如く";                       expectType = "exact";            expectId = "龍が如く" },
    @{ n = "95e. 龍が如く7は解決しない(REJECT維持)"; input = "龍が如く7";              expectType = "not-found";        expectId = $null },
    @{ n = "95f. 7外伝は従来どおり";          input = "龍が如く7外伝";                  expectType = "alias-exact";      expectId = "龍が如く7外伝 名を消した男" },
    @{ n = "96. 前方省略alias サクナヒメ";    input = "サクナヒメ";                     expectType = "alias-exact";      expectId = "天穂のサクナヒメ" },
    @{ n = "97. 略称alias なつもん";          input = "なつもん";                       expectType = "alias-exact";      expectId = "なつもん！ 20世紀の夏休み" },
    @{ n = "97a. 部分語では解決しない";       input = "なつ";                           expectType = "not-found";        expectId = $null },
    @{ n = "98. 算用数字表記alias DARK SOULS 3"; input = "DARK SOULS 3";               expectType = "alias-exact";      expectId = "DARK SOULS III" },
    @{ n = "98a. 大小文字";                   input = "Dark Souls 3";                   expectType = "canonical-alias";  expectId = "DARK SOULS III" },
    @{ n = "98b. 基本作は従来どおり";         input = "DARK SOULS";                     expectType = "exact";            expectId = "DARK SOULS" },
    @{ n = "98c. 別ナンバー2へは波及しない";  input = "DARK SOULS 2";                   expectType = "not-found";        expectId = $null },
    @{ n = "99. 前方表記alias The Witcher 3"; input = "The Witcher 3";                  expectType = "alias-exact";      expectId = "The Witcher 3: Wild Hunt" },
    @{ n = "99a. 番号なしは解決しない";       input = "The Witcher";                    expectType = "not-found";        expectId = $null },
    @{ n = "100. 感嘆符なしalias Golf It";    input = "Golf It";                        expectType = "alias-exact";      expectId = "Golf It!" },
    @{ n = "100a. 小文字";                    input = "golf it";                        expectType = "canonical-alias";  expectId = "Golf It!" },
    @{ n = "100b. 別作品みんなのGOLFは従来どおり"; input = "みんなのGOLF4";             expectType = "exact";            expectId = "みんなのGOLF4" },
    @{ n = "101. 前方表記alias リングフィット"; input = "リングフィット";               expectType = "alias-exact";      expectId = "リングフィットアドベンチャー" },
    @{ n = "102. コロンなしalias Silksong";   input = "Hollow Knight Silksong";         expectType = "alias-exact";      expectId = "Hollow Knight: Silksong" },
    @{ n = "102a. 別作品Hollow Knightは従来どおり"; input = "Hollow Knight";           expectType = "exact";            expectId = "Hollow Knight" },
    @{ n = "103. 略称alias スプラ3";          input = "スプラ3";                        expectType = "alias-exact";      expectId = "スプラトゥーン3" },
    @{ n = "103a. 全角数字";                  input = "スプラ３";                       expectType = "canonical-alias";  expectId = "スプラトゥーン3" },
    @{ n = "103b. スプラ単独は解決しない";    input = "スプラ";                         expectType = "not-found";        expectId = $null },
    @{ n = "103c. スプラ2はスプラトゥーン3へ寄らない"; input = "スプラ2";               expectType = "not-found";        expectId = $null },
    @{ n = "103d. 別作品スプラトゥーン2は従来どおり"; input = "スプラトゥーン2";        expectType = "exact";            expectId = "スプラトゥーン2" },
    # --- HOLD/REJECT維持(改善⑤): 続編・別版・同表記の割れ・ambiguous増があるため alias 化しない ---
    @{ n = "104. ラストオブアスは解決しない(HOLD)"; input = "ラストオブアス";            expectType = "not-found";        expectId = $null },

...
Write-Output "=============================="
Write-Output ""
Write-Output "人間確認後に data-playlists.js へ追記したら、そのあとで次を実行してください："
Write-Output "  .\refresh-playlist-meta.ps1 -OnlyMissing"
Write-Output "  追記した再生リストの updatedDate / thumbnailUrl をその場で取得します(数件なら数unit)。"
Write-Output "  実行しない場合、その再生リストは翌日の定期更新(GitHub Actions)で埋まるまでの間、"
Write-Output "  トップページの「最近更新された再生リスト」に実際の更新日ではなくサイト追加日で並びます。"
